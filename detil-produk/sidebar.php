...
?>
<div class="block">
	<div class="carousel slide" data-ride="carousel" id="randomize">
		<h4 class="title">
			<span class="pull-left"><span class="text">Randomize</span></span>
			<span class="pull-right">
				<a class="left button" href="#randomize" data-slide="prev"></a>
				<a class="right button" href="#randomize" data-slide="next"></a>
			</span>
		</h4>
		<div class="carousel-inner" role="listbox">
<?php
$sql_check = mysqli_query($conn,"SELECT * FROM produk WHERE no_brand = '".$_GET['b']."'");
...
<?php
$qry = mysqli_query($conn,"SELECT nomor FROM produk WHERE no_brand = '".$_GET['b']."'");
$jml = mysqli_num_rows($qry);

$no="";
for ($z=0; $z<$jml; $z++) {
	$no .= mysqli_result($qry, $z, 0)."_";
}
$long = strlen($no);
$get = substr($no, -$long, $long-1);
//memecah array $no berisi 3 nilai
$explode = explode("_", $get);
//membuat random array dari $explode dan mengambil 3 array dari $explode
$rand_array = array_rand($explode, 3);

$rand = rand(0,2);
$rand2 = rand(0,2);
$rand3 = rand(0,2);

$nmr = $explode[$rand_array[0]];
$nmr2 = $explode[$rand_array[1]];
$nmr3 = $explode[$rand_array[2]];

$sql_random = mysqli_query($conn,"SELECT * FROM produk WHERE nomor = '$nmr'");
$detail = mysqli_fetch_array($sql_random);
...
//link utk mengarah ke produk detail
...
$cut_img2 = explode(",", $detail['gambar_produk']);
?>
					<li class="col-sm-12">
						<div class="product-box">
							<a href="<?php echo $produk_detil;?>" class="tag-disc"><?php echo $diskon; ?></a>
							<a href="<?php echo $produk_detil;?>"><img alt="" src="<?php echo $host."/image/produk/".$cut_img2[0];?>">
							<p><?php echo $detail['nama_produk']; ?></p></a>
							<?php echo $rs; ?>
			...
			<div class="item">
				<ul class="dtl-products">
<?php
$sql_random2 = mysqli_query($conn,"SELECT * FROM produk WHERE nomor = '$nmr2'");
$detail2 = mysqli_fetch_array($sql_random2);
...
//link mengarah ke produk detil
$produk_detil2 = $host."/detil-produk/?k=".$detail2['no_kategori']."&b=".$detail2['no_brand']."&p=".$detail2['nomor'];

//memecah nama-nama gambar pada database
$cut_img3 = explode(",", $detail2['gambar_produk']);
?>
					<li class="col-sm-12">
						<div class="product-box">
							<a href="<?php echo $produk_detil2;?>" class="tag-disc"><?php echo $diskon2; ?></a>
							<a href="<?php echo $produk_detil2;?>"><img alt="" src="<?php echo $host."/image/produk/".$cut_img3[0];?>">
							<p><?php echo $detail2['nama_produk']; ?></p></a>
							<?php echo $rs2; ?>
			...
			<div class="item">
				<ul class="dtl-products">
<?php
$sql_random3 = mysqli_query($conn,"SELECT * FROM produk WHERE nomor = '$nmr3'");
$detail3 = mysqli_fetch_array($sql_random3);
...
//link ke produk detil
$produk_detil3 = $host."/detil-produk/?k=".$detail3['no_kategori']."&b=".$detail3['no_brand']."&p=".$detail3['nomor'];

//memecah nama-nama gambar pada database
$cut_img4 = explode(",", $detail3['gambar_produk']);
?>
					<li class="col-sm-12">
						<div class="product-box">
							<a href="<?php echo $produk_detil3;?>" class="tag-disc"><?php echo $diskon3; ?></a>
							<a href="<?php echo $produk_detil3;?>"><img alt="" src="<?php echo $host."/image/produk/".$cut_img4[0];?>">
							<p><?php echo $detail3['nama_produk']; ?></p></a>
							<?php echo $rs3; ?>
...
<div class="block">
	...
	<?php
	$get_kat  = $_GET['k'];
	$sql_best = mysqli_query($conn,"SELECT * FROM produk WHERE no_kategori = '$get_kat' ORDER BY terjual DESC LIMIT 5");
	while($best = mysqli_fetch_assoc($sql_best)){
		$produk_detil3 = $host."/detil-produk/?k=".$detail3['no_kategori']."&b=".$detail3['no_brand']."&p=".$detail3['nomor'];
		$gb = explode(",", $best['gambar_produk']);
	?>
		<li>
			<table>
				<tr>
					<td>
						<a href="<?php echo "$host/detil-produk/?k=$best[no_kategori]&b=$best[no_brand]&p=$best[nomor]"; ?>">
							<img src="<?php echo "$host/image/produk/$gb[0]"; ?>" alt="best-product">
						</a>
					</td>
					<td><a href="<?php echo "$host/detil-produk/?k=$best[no_kategori]&b=$best[no_brand]&p=$best[nomor]"; ?>"><?php echo substr(ucfirst($best['nama_produk']),0,30)."..."; ?></a></td>
				</tr>
			</table>
		</li>
	<?php

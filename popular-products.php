...
<div class="well well-small" style="padding:5px auto;background:white;">
	<div class="row-fluid">
		<div id="popular_produk" class="carousel slide" data-ride="carousel" data-interval="3000">
			<h4 class="title">
				<span class="pull-left"><span class="text"><span class="line">Produk <strong>Terpopuler</strong></span></span></span>
				<span class="pull-right">
					<a class="left button" href="#popular_produk" data-slide="prev"></a>
					<a class="right button" href="#popular_produk" data-slide="next"></a>
				</span>
			</h4>
			<div class="row carousel-inner">
				<div class="item active">
					...
					<?php
$sql_related = mysqli_query($conn,"SELECT * FROM produk ORDER BY dilihat DESC LIMIT 0,4");
...
?>
				...
				<div class="item">
					<ul class="dtl-products">
					<?php
$sql_related2 = mysqli_query($conn,"SELECT * FROM produk ORDER BY dilihat DESC LIMIT 4,4");
...
$total_img2 = count($ex_img2);
				...
				<div class="item">
					<ul class="dtl-products">
					<?php
$sql_related3 = mysqli_query($conn,"SELECT * FROM produk ORDER BY dilihat DESC LIMIT 8,4");

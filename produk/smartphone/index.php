...
if (@$_GET['ets'] != "smartphone") {
	header("location: $host/produk/smartphone/?ets=smartphone");
}else{
?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>Smartphone | EraTekno-Shop</title>
...
<body>
	...
	<div id="kategory"><button id="btn-kat" class="btn btn-default btn-lg">Kategori Belanja <i class="glyphicon glyphicon-circle-arrow-down"></i></button><div id="slide-kat"><?php include_once("../../kategori.php"); ?></div>
		...
		breadcrumbs2("Produk","Smartphone",$host,"$host/produk/");
		?>
	</div>
